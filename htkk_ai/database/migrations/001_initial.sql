...
CREATE INDEX IF NOT EXISTS idx_form_drafts_form_code ON form_drafts(form_code);

CREATE INDEX IF NOT EXISTS idx_sessions_expires ON user_sessions(expires_at);
CREATE INDEX IF NOT EXISTS idx_sessions_user ON user_sessions(user_id);
CREATE INDEX IF NOT EXISTS idx_sessions_privacy ON user_sessions(privacy_tier);
...
CREATE INDEX IF NOT EXISTS idx_template_form_code ON template_cache(form_code);
CREATE INDEX IF NOT EXISTS idx_template_accessed ON template_cache(last_accessed);

CREATE INDEX IF NOT EXISTS idx_assessment_session ON assessment_cache(session_id);
CREATE INDEX IF NOT EXISTS idx_assessment_user ON assessment_cache(user_id);
CREATE INDEX IF NOT EXISTS idx_assessment_expires ON assessment_cache(expires_at);
